...
Systemd est un service de gestion du système linux et ...
...
`cat` concatène un input et le renvoie.
`tee` copie l'input pour le renvoyer dans l'output. Mais ne peut pas l'afficher ? 
